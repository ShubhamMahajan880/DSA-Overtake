...
// Array anothe basic details - 
    ...
    // }
    // cout<<endl;
    // // 0 0 0 0 0 0  - by using it All THE Array elemnt can be initialize from 0 ata a time
    ...
    // }
    // cout<<endl;
    // // 1 0 0 0 0 0  - it doen't mean that for the same syntax for any value, all elements will have that value.
